 ...
 */
public interface ApiStudioProtocolAuthoring {
...
public class ApiStudioProtocolAuthoringRegistry(
    contributions: List<ApiStudioProtocolAuthoring> = emptyList(),
) {
    private val byKind = contributions.associateBy(ApiStudioProtocolAuthoring::kind).also { indexed ->
    ...
    private fun contribution(kind: RequestKindId): ApiStudioProtocolAuthoring =
