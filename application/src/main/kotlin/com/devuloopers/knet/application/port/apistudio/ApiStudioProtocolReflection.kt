...
public interface ApiStudioProtocolReflectionPort {
...
public class ApiStudioProtocolReflectionRegistry(
    contributions: List<ApiStudioProtocolReflectionPort> = emptyList(),
) {
    private val byKind = contributions.associateBy(ApiStudioProtocolReflectionPort::kind).also { indexed ->
    ...
    private fun contribution(kind: RequestKindId): ApiStudioProtocolReflectionPort =
