...
public interface TrustedDeviceStorePort {
    ...
    public suspend fun getDevice(id: PairedDeviceId): TrustedDevice?
    public suspend fun revoke(id: PairedDeviceId, revokedAtEpochMillis: Long): Boolean
...
public class PairingCoordinator(
    ...
    public suspend fun revoke(deviceId: PairedDeviceId): Boolean = store.revoke(deviceId, nowMillis())
