 ...
 * accounting for all preceding collapsed fold regions.
 *
 ...
 *
 * @param lineIndex 0-indexed line position to toggle.
 * @param displayedText Current text content in the text field.
 * @param collapsedFolds Active map of collapsed fold states.
 * @param foldStartLines Map of start line to [FoldRegion].
...
fun performFoldToggle(
    ...
    if (collapsedFolds.containsKey(lineIndex)) {
        ...
        val endLine = foldRegion.endLine
