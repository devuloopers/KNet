 ...
 *
 * Darwin and Security-framework TLS protect invitation redemption and control requests. Native Network,
 * certificate installation/readiness, and Network Extension dependencies remain unavailable until their adapters
 * are implemented, qualified, and registered by a future iOS product composition root.
 */
