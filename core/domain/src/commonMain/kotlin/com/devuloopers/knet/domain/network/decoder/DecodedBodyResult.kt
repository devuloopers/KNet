 ...
 */
public sealed interface DecodedBodyResult {
    /**
     ...
     */
    public data class Success(val bytes: ByteArray, val encoding: ContentEncoding) : DecodedBodyResult {
     ...
     */
    public data class Identity(val bytes: ByteArray) : DecodedBodyResult {
        override fun equals(other: Any?): Boolean {
            if (this === other) return true
     ...
     */
    public data class UnsupportedEncoding(val encoding: String, val rawBytes: ByteArray) : DecodedBodyResult {
        override fun equals(other: Any?): Boolean {
            if (this === other) return true
     ...
     * @property rawBytes The original raw payload bytes.
     */
    public data class CorruptedEncoding(val encoding: String, val errorMessage: String, val rawBytes: ByteArray) : DecodedBodyResult {
        override fun equals(other: Any?): Boolean {
            if (this === other) return true
