...
| Name | Hex | Usage |
|------|-----|-------|
| Primary | `#3081FC` | Gradient start, CTA, accents |
| Secondary | `#6366F1` | Gradient end, hover states |
| Text (light bg) | `#0D1117` | Body text on white/light |
| Text (dark bg) | `#FFFFFF` | Body text on dark |
| Background (light) | `#FFFFFF` | Light mode |
| Background (dark) | `#0D1117` | Dark mode |
