 ...
 *
 * Note: This does NOT perform domain-based header injection.
 * Universal HTTP default headers (User-Agent, Accept, Accept-Encoding, Connection, Host, KNet-Token)
 * are pre-seeded directly in [SavedApiRequest.headers] via [defaultHeaders].
 */
