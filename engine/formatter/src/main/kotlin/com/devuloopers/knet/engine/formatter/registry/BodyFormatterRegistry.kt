...
object BodyFormatterRegistry {
     ...
     * @param bodyText Raw body text.
     * @return Strongly-typed [BodyFormat].
     */
    fun resolveFormat(headers: Map<String, String>, bodyText: String): BodyFormat {
        ...
        when {
            ...
            mime.contains("grpc-web") || mime.contains("grpc-web-text") -> return grpcWebFormatter.format(
                headers,
                trimmed
            )
     ...
     * @param headers HTTP headers map.
     * @param bodyText Raw body text.
     * @return Formatted multi-line text string.
     */
