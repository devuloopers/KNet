package com.devuloopers.knet.logger

import co.touchlab.kermit.Logger

/**
 * Core logging wrapper for KNet, routing all logging events through Kermit.
 * This class abstracts the logging backend, allowing dynamic routing of logs (e.g., to a UI console).
 */
object KNetLogger {
     ...
     */
    inline fun info(tag: String = "KNet", message: () -> String) {
     ...
     * @param message The lambda returning the log message (lazy evaluation).
     */
    inline fun debug(tag: String = "KNet", message: () -> String) {
     ...
     * @param message The lambda returning the log message (lazy evaluation).
     */
    inline fun warn(tag: String = "KNet", message: () -> String) {
     ...
     * @param message The lambda returning the log message (lazy evaluation).
     */
    inline fun error(tag: String = "KNet", throwable: Throwable? = null, message: () -> String) {
