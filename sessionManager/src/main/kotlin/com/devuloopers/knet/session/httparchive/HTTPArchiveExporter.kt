...
/**
 * Exporter utility responsible for serializing transaction records to standard HTTP Archive (HAR) 1.2 JSON structures.
 * Uses kotlinx.serialization for type-safe compile-time validated JSON outputs.
 */
object HTTPArchiveExporter {
    ...
    /**
     * Serializes a list of [HttpTransaction] records into a standard HAR 1.2 JSON string.
     *
     * @param transactions The records list to export.
     * @return Fully formatted HAR 1.2 JSON string.
     */
