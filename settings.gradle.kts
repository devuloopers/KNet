...
include(":products:companion:di")
project(":products:companion:di").projectDir = file("products/companion/di")
include(":products:companion:androidApp")
project(":products:companion:androidApp").projectDir = file("products/companion/androidApp")
include(":products:companion:iosApp")
project(":products:companion:iosApp").projectDir = file("products/companion/iosApp")
include(":products:companion:iosPacketTunnel")
project(":products:companion:iosPacketTunnel").projectDir = file("products/companion/iosPacketTunnel")
...
include(":engine:websocket")
project(":engine:websocket").projectDir = file("engine/websocket")
include(":engine:graphqlWebSocket")
project(":engine:graphqlWebSocket").projectDir = file("engine/graphqlWebSocket")
include(":engine:sse")
project(":engine:sse").projectDir = file("engine/sse")
include(":core:domain")
...
include(":ui:desktop:apiStudio:websocket")
project(":ui:desktop:apiStudio:websocket").projectDir = file("ui/desktop/apiStudio/websocket")
include(":ui:desktop:apiStudio:graphqlWebSocket")
project(":ui:desktop:apiStudio:graphqlWebSocket").projectDir = file("ui/desktop/apiStudio/graphqlWebSocket")
...
project(":application:desktop").projectDir = file("application/desktop")
...
include(":core:companion")
project(":core:companion").projectDir = file("core/companion")
include(":application:companion")
project(":application:companion").projectDir = file("application/companion")
include(":data:companion")
project(":data:companion").projectDir = file("data/companion")
include(":ui:companion:presentation")
project(":ui:companion:presentation").projectDir = file("ui/companion/presentation")
include(":ui:companion:sharedUi")
project(":ui:companion:sharedUi").projectDir = file("ui/companion/sharedUi")
include(":connectivity:desktop")
project(":connectivity:desktop").projectDir = file("connectivity/desktop")
include(":connectivity:companion")
project(":connectivity:companion").projectDir = file("connectivity/companion")
