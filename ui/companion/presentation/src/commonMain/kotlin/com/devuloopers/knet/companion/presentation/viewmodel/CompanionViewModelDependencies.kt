 ...
 * @property observeCertificateEnrollments observes durable certificate-onboarding completion.
 ...
 * @property monitorDesktopAvailability proves paired-desktop reachability while operational Home is idle.
 ...
 * @property completeCertificateEnrollment verifies trust again and persists explicit setup completion.
...
public data class CompanionViewModelDependencies(
    ...
    public val observeCertificateEnrollments: ObserveCompanionCertificateEnrollmentsUseCase,
    ...
    public val monitorDesktopAvailability: CompanionDesktopAvailabilityMonitor,
    ...
    public val completeCertificateEnrollment: CompleteCompanionCertificateEnrollmentUseCase,
