...
/** Uses Android's touch-native scrolling without adding desktop scrollbar chrome. */
@Composable
internal actual fun PlatformKNetVerticalScrollbar(scrollState: ScrollState, modifier: Modifier) = Unit

/** Uses Android's touch-native lazy-list scrolling without adding desktop scrollbar chrome. */
@Composable
internal actual fun PlatformKNetVerticalScrollbar(lazyListState: LazyListState, modifier: Modifier) = Unit

/** Uses Android's touch-native horizontal scrolling without adding desktop scrollbar chrome. */
@Composable
