...
/**
 * Unit tests verifying property accessors and structure of the [CaDetails] class.
 */
class CaDetailsTest {

    /**
     * Verifies that the [CaDetails] class has correct default properties upon instantiation.
     *
     * Design Intent: Ensures fallback values exist for CA details before they are populated from the backend.
     */
    @Test
    fun testCaDetailsDefaultProperties() {
        val details = CaDetails()
    ...
    /**
     * Verifies that custom parameter construction of [CaDetails] is assigned correctly.
     *
     * Design Intent: Verifies standard fields representing X509 attributes are correctly mapped.
     */
    @Test
    fun testCaDetailsCustomValues() {
        val details = CaDetails(
