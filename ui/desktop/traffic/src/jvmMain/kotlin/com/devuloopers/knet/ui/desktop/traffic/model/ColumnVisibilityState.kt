 ...
 */
public data class ColumnVisibilityState(
     ...
     */
    public fun isVisible(column: TrafficColumn): Boolean = column.isMandatory || visibleColumns.contains(column)

    /**
     * Toggles visibility of a non-mandatory column.
     */
    public fun toggle(column: TrafficColumn): ColumnVisibilityState {
